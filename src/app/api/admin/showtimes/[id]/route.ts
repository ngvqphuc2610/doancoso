...
export async function GET(
    ...
    try {
        const { id } = params;
        const response = await axios.get(getApiUrl(`/api/admin/showtimes/${id}`), {
            timeout: 5000
        });
...
export async function PUT(
    ...
    try {
        ...
        const response = await axios.put(getApiUrl(`/api/admin/showtimes/${id}`), body, {
            timeout: 5000
        });
        return NextResponse.json(response.data);
    } catch (error: any) {
...
export async function DELETE(
    ...
    try {
        const { id } = params;
        const response = await axios.delete(getApiUrl(`/api/admin/showtimes/${id}`), {
            timeout: 5000
        });
        return NextResponse.json(response.data);
    } catch (error: any) {
...
export async function PATCH(
    ...
    try {
        const { id } = params;
        const body = await req.json();
        const response = await axios.patch(getApiUrl(`/api/admin/showtimes/${id}`), body, {
            timeout: 5000
        });
        return NextResponse.json(response.data);
    } catch (error: any) {
