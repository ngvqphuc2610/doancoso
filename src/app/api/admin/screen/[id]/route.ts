...
export async function GET(
    ...
    try {
        const { id } = params;
        const response = await axios.get(`${API_URL}/api/admin/screen/${id}`, {
            timeout: 5000
        });
...
export async function PUT(
    ...
    try {
        ...
        const response = await axios.put(`${API_URL}/api/admin/screen/${id}`, body, {
            timeout: 5000
        });
        return NextResponse.json(response.data);
    } catch (error: any) {
...
export async function DELETE(
    ...
    try {
        const { id } = params;
        const response = await axios.delete(`${API_URL}/api/admin/screen/${id}`, {
            timeout: 5000
        });
        return NextResponse.json(response.data);
    } catch (error: any) {
...
export async function PATCH(
    ...
    try {
        const { id } = params;
        const body = await req.json();
        const response = await axios.patch(`${API_URL}/api/admin/screen/${id}`, body, {
            timeout: 5000
        });
        return NextResponse.json(response.data);
    } catch (error: any) {
